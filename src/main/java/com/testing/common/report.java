...
public class report {
	...
	public void sendreport (String resultFile,String startTime)  {
		...
		map.put("email", "1508353980@qq.com");
		map.put("mailpass", "ongoauxowrokieii");
		map.put("sendnick", "Roy");
		map.put("host", "smtp.qq.com");
		map.put("recievers", "578225840@qq.com");
		map.put("copylist", "578225840@qq.com");
